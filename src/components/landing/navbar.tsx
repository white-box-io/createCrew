                            ...
                            <>
                                ...
                                <div className='relative' ref={dropdownRef}>
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            className={`h-3.5 w-3.5 text-brand-gray transition-transform ${profileOpen ? 'rotate-180' : ''}`}
                                        />
                                    </button>
                            ...
                            <>
                                <Link href='/become-crew'>
                                    <Button
                                        variant='outline'
                                        size='sm'
                                        className='rounded-md border-brand-indigo/30 text-brand-indigo hover:bg-brand-indigo/5 font-semibold'
                                    >
                                        Become a Crew
                                    </Button>
                                </Link>
                                ...
                                <Link href='/signup'>
                                    <Button
                                        size='sm'
                                        className='bg-brand-coral text-white hover:bg-brand-coral-dark rounded-md font-semibold'
                                    >
                                        Join
